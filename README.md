...
<img class="img-fluid" style="display: block; margin: 0 auto;" src="./age_met_table.png" width="500">
...
<img class="img-fluid" style="display: block; margin: 0 auto;" src="./trueage_vs_bestage.png" width="500">
...
<img class="img-fluid" style="display: block; margin: 0 auto;" src="./kcorr_rband.png" width="500">

<h2 style="text-align: center;">G-band K-correction: </h2>
<img class="img-fluid" style="display: block; margin: 0 auto;" src="./kcorr_gband.png" width="500">
...
<img class="img-fluid" style="display: block; margin: 0 auto;" src="./ml_vs_L_alloneplot.png" width="500">


<h2 style="text-align: center;">$$\frac{M_*}{L}$$ vs $$L$$ Bin Separated: </h2>
<img class="img-fluid" style="display: block; margin: 0 auto;" src="./ml_vs_L_tformbin_cluster.png" width="500">
...
<img class="img-fluid" style="display: block; margin: 0 auto;" src="./colore_vs_vdisp.png" width="500">

<h2 style="text-align: center;">Residuals vs. Age in bins of Absolute Magnitude: </h2>
<img class="img-fluid" style="display: block; margin: 0 auto;" src="./resid_vs_age_magbins.png" width="500">
